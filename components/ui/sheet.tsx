...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-10 px-4 sm:text-left ", className)}
    {...props}
  />
);
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-foreground font-sans", className)} // Simplified className
    {...props}
  />
));
